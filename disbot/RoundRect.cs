...
namespace DisBot {
    ...
    public static class RoundRect {
        ...
        public static void FillRoundRectangle(this Graphics self, Brush brush,
          int x, int y,
          int width, int height, int radius) {
            ...
            self.FillRoundRectangle(brush, fx, fy,
        ...
        public static void DrawRoundRectangle(this Graphics self, Pen pen, int x, int y, int width, int height, int radius) {
            float fx = Convert.ToSingle(x);
            float fy = Convert.ToSingle(y);
            float fwidth = Convert.ToSingle(width);
            float fheight = Convert.ToSingle(height);
            float fradius = Convert.ToSingle(radius);
            self.DrawRoundRectangle(pen, fx, fy, fwidth, fheight, fradius);
        }

        public static void DrawRoundRectangle(this Graphics self, Pen pen, float x, float y,
          float width, float height, float radius) {
            RectangleF rectangle = new RectangleF(x, y, width, height);
            GraphicsPath path = GetRoundedRect(rectangle, radius);
